...
beam_type = 'laguerre3_counterProp';
...
iterations = 100;    %How many cycles of the dynamics of the motion you want to compute
...
for iter=1:iterations
    ...
    switch beam_type
        case 'gaussian'
            ...
            'index_medium', n_medium, 'wavelength0', wavelength0);
        case 'laguerre3'
            %Circular polarisation laguerre Gaussian 3
            beam = ott.BscPmGauss('lg', [ 0 3 ], ...
            'polarisation', [ 1 1i ], 'NA', numerical_aperture, ...
            'index_medium', n_medium, 'wavelength0', wavelength0);
        case 'laguerre3_counterProp'
            %Circular polarisation laguerre Gaussian 3
...
disp("Program end, showing animation...");
