...
mode_sequence = ["Sweep_Particle_Rad", "All_Particles_R_Theta"];%"Sweep_Particle_Rad";%"View_Beam";
%%MODES
for mode = mode_sequence
    ...
    elseif(mode == "All_Particles_R_Theta")
        ...
        particle_rad = 1e-6;
        particle_dist = 0.7e-6;
        num_particles = 10;
        All_Particles_R_Theta(num_particles, particle_dist, particle_rad);
    end
end
...
function output = All_Particles_R_Theta(particle_iter_max, distance, radius)
