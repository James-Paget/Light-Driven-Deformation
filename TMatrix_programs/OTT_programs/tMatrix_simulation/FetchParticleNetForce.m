...
####
CURRENTLY ONLY SETUP FOR SPHERES AND CUBES DUE TO NATURE OF CREATING
BOUNDING ZONE
####
%}
function output = FetchParticleNetForce(particle, beam, T, samples)
    %####
    %## CURRENTLY JUST PERFORMING THIS IN THE Z=0 PLANE
    %##     -> COULD EXTEND QUITE EASILY BUT ONLY IN A SMALL BRAIN WAY
    %####
